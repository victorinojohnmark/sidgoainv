  ...
  <table>
    <tr>
      <td rowspan="4" style="width:60px; padding:10px;">
        <img src="/image/{{ $checkout->location->company->logo }}" alt="HRM Logo" style="width:100%;">
      </td>
    </tr>
    <tr>
      <td><h2>{{ $checkout->location->company->name }}</h2></td>
    </tr>
    <tr>
      <td>{{ $checkout->location->company->address }}</td>
    </tr>
    <tr>
      <td>Tel.: {{ $checkout->location->company->contact }} | Email: {{ $checkout->location->company->email }} <br> Website: https://hrmprintersandtoners.com</td>
    </tr> 
  </table>
  <br>
